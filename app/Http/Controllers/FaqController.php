...
class FaqController extends AppBaseController {
    ...
    public static function faqData() {
        $locale = App::getLocale();
        if ($locale === 'pl') {
            $faqs = DB::table('faq')->select('id as no', 'question_pl as question', 'answer_pl as answer')->get();
        } else {
            $faqs = DB::table('faq')->select('id as no', 'question_pl_en as question', 'answer_en as answer')->get();
        }
        return $faqs;
    }
